...
namespace AluguelDeCarros.Controllers
{
    public class CarroesController : Controller
    {
        ...
        public CarroesController(AluguelDeCarrosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Marca,PrecoPorDia,Disponivel")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Marca,PrecoPorDia,Disponivel")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
